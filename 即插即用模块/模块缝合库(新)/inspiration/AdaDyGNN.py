...
if __name__ == '__main__':
    n_nodes = 100
    n_neighbors = 5
    n_update_neighbors = 3
    edge_dim = 10
    emb_dim = 20
    message_dim = 30
    edge_feat = np.random.rand(n_nodes, n_nodes, edge_dim)
    timestamps = np.random.rand(n_nodes)
    src_idxs = torch.randint(0, n_nodes, (10,))
    dst_idxs = torch.randint(0, n_nodes, (10,))
    neg_idxs = torch.randint(0, n_nodes, (10,))
    edge_idxs = torch.randint(0, n_nodes, (10,))
    tot_time = 1.0  # 设置一个示例值

    # Create an instance of AdaDyGNN
    block = AdaDyGNN(n_nodes, n_neighbors, n_update_neighbors, edge_dim, emb_dim, message_dim, edge_feat, tot_time)

    # Forward pass
    pos_score, neg_score, policy_loss, reward = block.forward(src_idxs, dst_idxs, neg_idxs, edge_idxs, timestamps)

    print("Input size:", src_idxs.size())
    print("Output size:", pos_score.size(), neg_score.size(), policy_loss, reward)
...
# if __name__ == '__main__':
#     # Instantiate AdaDyGNN block
#     n_nodes = 100
#     n_neighbors = 10
#     n_update_neighbors = 5
#     edge_dim = 20
#     emb_dim = 50
#     message_dim = 30
#     tot_time = 100
#     device = 'cuda' if torch.cuda.is_available() else 'cpu'
#     block = AdaDyGNN(n_nodes, n_neighbors, n_update_neighbors, edge_dim, emb_dim, message_dim,
#                      neighbor_finder=None, edge_feat=np.random.rand(n_nodes, edge_dim), tot_time=tot_time,
#                      device=device)
#
#     # Generate dummy input data
#     src_idxs = torch.randint(0, n_nodes, (32,))
#     dst_idxs = torch.randint(0, n_nodes, (32,))
#     neg_idxs = torch.randint(0, n_nodes, (32,))
#     edge_idxs = torch.randint(0, n_nodes, (32,))
#     timestamps = np.random.rand(n_nodes)
#
#     # Forward pass
#     pos_score, neg_score, policy_loss, reward = block(src_idxs, dst_idxs, neg_idxs, edge_idxs, timestamps)
#
#     # Print input and output sizes
#     print("Input size:")
#     print("src_idxs:", src_idxs.size())
#     print("dst_idxs:", dst_idxs.size())
#     print("neg_idxs:", neg_idxs.size())
#     print("edge_idxs:", edge_idxs.size())
#     print("timestamps:", timestamps.shape)
#
#     print("\nOutput size:")
#     print("pos_score:", pos_score.size())
#     print("neg_score:", neg_score.size())
#     print("policy_loss:", policy_loss.size())  # This might be scalar
#     print("reward:", reward.size())  # This might be scalar
